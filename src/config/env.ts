...
export const env = {
    ...
    LEGACY_API_BASE_URL: requiredEnvVar("LEGACY_API_BASE_URL", process.env.LEGACY_API_BASE_URL || ""),
    SSE_URL: requiredEnvVar("SSE_URL", process.env.SSE_URL || ""),
    HTTP_TIMEOUT_MS: toNumber("HTTP_TIMEOUT_MS", process.env.HTTP_TIMEOUT_MS, 5000),
    HTTP_MAX_RETRIES: toNumber("HTTP_MAX_RETRIES", process.env.HTTP_MAX_RETRIES, 3),
    HTTP_RETRY_BASE_DELAY_MS: toNumber("HTTP_RETRY_BASE_DELAY_MS", process.env.HTTP_RETRY_BASE_DELAY_MS, 500),
    SYNC_STATE_KEY: requiredEnvVar("SYNC_STATE_KEY", process.env.SYNC_STATE_KEY || "main"),
}